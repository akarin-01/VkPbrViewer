...
namespace Kita::Pbrv
{
    ...
    {
        RenderImageView* imageView = m_resources.GetImageView(m_resolveTex.m_imageViewHandle);
    ...
    {
        RenderImage* image = m_resources.GetImage(m_resolveTex.m_imageHandle);
    ...
    {
        // Color texture
        DestroyTexture(m_resources, m_colorTex);
        m_colorLayout = VK_IMAGE_LAYOUT_UNDEFINED;

        // Resolve texture
        DestroyTexture(m_resources, m_resolveTex);
        m_resolveLayout = VK_IMAGE_LAYOUT_UNDEFINED;

        // Depth texture
        DestroyTexture(m_resources, m_depthTex);
