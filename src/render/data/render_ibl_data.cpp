...
namespace Kita::Pbrv
{
    namespace Render
    {
            ...
            m_descriptorAllocator(descriptorAllocator)
        {
            ...
            Core::Log::Info("[Renderer] Create BRDF LUT: ", kBrdfLutSize, "x", kBrdfLutSize, " RG16F");
        ...
        {
            const VkFormat format = m_context.HdrFormat();
            const uint32_t mipLevels = Rhi::CalculateMipLevels(kPrefilterBaseSize, kPrefilterBaseSize);
